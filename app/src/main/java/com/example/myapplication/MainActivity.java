...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view){
        ...
        final CharSequence[] items = {getText(R.string.red),
                getText(R.string.yellow), getText(R.string.green), getText(R.string.orange)
        };
            ...
            public void onClick(DialogInterface dialog, int item) {
                switch (item) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        relativeLayout.setBackgroundResource(R.color.orangeColor);
                        Toast.makeText(context, R.string.orange, Toast.LENGTH_LONG).show();
                        break;
                }
            }
        });
